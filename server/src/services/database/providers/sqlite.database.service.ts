...
/**
 * SQLite database service implementation using better-sqlite3
 */
export class SqliteDatabaseService implements IDatabaseService {
  ...
  constructor(dbPath: string) {
    ...
    logger.info('SQLite database initialized', { path: resolvedDbPath, type: 'sqlite' });
    this.initialize();
  }
  ...
  private initialize(): void {
    ...
    logger.info('SQLite database tables initialized', { fileCount: count.count });
  }
